...
#ifndef WCSFM_SWIFT_H
#define WCSFM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="wcsfm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5wcsfm13FloatingPanel")
...
SWIFT_CLASS("_TtC5wcsfm20HistoryWindowManager")
@interface HistoryWindowManager : NSObject <NSWindowDelegate>
